...
void serialib::closeDevice()
{
   ...
   /// A nous
    ...
    void serialib::setTimeOut(unsigned int timeOut_ms)
    {  timeouts.ReadTotalTimeoutConstant=timeOut_ms;

        if(!SetCommTimeouts(hSerial, &timeouts)) return;
    }
...
/*!
  ...
  */
  ...
  char serialib::readChar2    (char *pByte)
  {
